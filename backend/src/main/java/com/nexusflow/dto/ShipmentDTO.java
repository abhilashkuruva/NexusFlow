...
public class ShipmentDTO {
    ...
    @jakarta.validation.constraints.NotNull(message = "Supplier ID is required")
    private Long supplierId;
    private String supplierName;

    @jakarta.validation.constraints.NotBlank(message = "Origin city is required")
    private String originCity;

    @jakarta.validation.constraints.NotBlank(message = "Origin country is required")
    private String originCountry;

    @jakarta.validation.constraints.NotBlank(message = "Destination city is required")
    private String destinationCity;

    @jakarta.validation.constraints.NotBlank(message = "Destination country is required")
    private String destinationCountry;

    private String currentLocation;
    private Integer quantity;

    @jakarta.validation.constraints.NotNull(message = "Shipment date is required")
    private LocalDate shipmentDate;

    @jakarta.validation.constraints.NotNull(message = "Estimated delivery date is required")

...
-- Seed the runtime demo users here so the app can boot cleanly on a fresh database.
INSERT IGNORE INTO users (id, email, password, first_name, last_name, role, is_active) VALUES
(1, 'admin@nexusflow.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOHiH6Hn7TRQ6jMnIKh4j/wQUp3NEEraW', 'Admin', 'User', 'ADMIN', TRUE),
(2, 'manager@nexusflow.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOHiH6Hn7TRQ6jMnIKh4j/wQUp3NEEraW', 'SupplyChain', 'Manager', 'SUPPLY_MANAGER', TRUE),
(3, 'logistics@nexusflow.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOHiH6Hn7TRQ6jMnIKh4j/wQUp3NEEraW', 'Logistics', 'User', 'LOGISTICS_MANAGER', TRUE),
(4, 'supplier@nexusflow.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOHiH6Hn7TRQ6jMnIKh4j/wQUp3NEEraW', 'Supplier', 'User', 'SUPPLIER', TRUE),
(5, 'analyst@nexusflow.com', '$2a$10$7EqJtq98hPqEX7fNZaFWoOHiH6Hn7TRQ6jMnIKh4j/wQUp3NEEraW', 'Data', 'Analyst', 'ANALYST', TRUE);
...
INSERT IGNORE INTO suppliers (id, name, contact_person, email, phone, address, country, location, industry,
    reliability_score,
    ...
    supplier_risk_score,
    risk_level,
    total_shipments, delayed_shipments, is_active)
VALUES 
(1, 'Global Tech Supplies', 'John Smith', 'john@globaltech.com', '+1-555-0101', '123 Tech Ave', 'USA', 'San Francisco', 'Electronics', 4.50,
    18.00, 22.00, 20.00, 15.00, 22.00, 97.00, 'CRITICAL', 150, 12, TRUE),
(2, 'Asia Manufacturing Co', 'Li Wei', 'liwei@asiamanuf.com', '+86-138-0000-1234', '456 Industry Rd', 'China', 'Shanghai', 'Manufacturing', 4.20,
    24.00, 26.00, 18.00, 20.00, 19.00, 107.00, 'CRITICAL', 200, 25, TRUE),
(3, 'European Logistics GmbH', 'Hans Mueller', 'hans@eurolog.de', '+49-30-12345678', '789 Logistics Str', 'Germany', 'Hamburg', 'Logistics', 4.80,
    12.00, 14.00, 12.00, 10.00, 14.00, 62.00, 'HIGH', 100, 5, TRUE),
(4, 'Indian Exports Ltd', 'Raj Patel', 'raj@indianexp.in', '+91-98765-43210', '321 Export Zone', 'India', 'Mumbai', 'Textiles', 3.90,
    30.00, 28.00, 22.00, 24.00, 26.00, 130.00, 'CRITICAL', 180, 35, TRUE),
(5, 'Latin American Traders', 'Maria Garcia', 'maria@latamtraders.com', '+52-55-1234-5678', '654 Comercio Blvd', 'Mexico', 'Mexico City', 'Food & Beverage', 4.10,
    22.00, 20.00, 17.00, 19.00, 16.00, 94.00, 'HIGH', 120, 18, TRUE);


-- Insert sample warehouses (needed for inventory FK)
INSERT IGNORE INTO warehouses (id, warehouse_name, location, country, city, address, capacity, manager_name, contact_phone, contact_email, warehouse_type, is_active, created_at, updated_at)
VALUES
(1, 'Warehouse A', 'Main', 'USA', 'San Francisco', '123 Main St', 50000, 'Ops Manager A', '+1-555-0100', 'warehouse-a@nexusflow.com', 'Distribution', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'Warehouse B', 'Main', 'China', 'Shanghai', '456 Main St', 45000, 'Ops Manager B', '+86-21-5500-1200', 'warehouse-b@nexusflow.com', 'Distribution', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert sample inventory (aligned with Inventory.java schema)
INSERT IGNORE INTO inventory (product_id, warehouse_id, available_quantity, reserved_quantity, minimum_stock_level, maximum_stock_level, reorder_point, unit_cost, total_value, last_stock_check, shortage_probability_pct, safety_stock_level, shortage_risk_level, is_active, created_at, updated_at)
VALUES
(1, 1, 500, 50, 100, 1500, 200, 315.00, 157500.00, CURRENT_TIMESTAMP, 12.50, 250, 'LOW', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 50, 5, 20, 300, 25, 840.00, 42000.00, CURRENT_TIMESTAMP, 68.00, 80, 'HIGH', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);



-- Insert sample risk scores (20 total so dashboard charts have enough data)
INSERT IGNORE INTO risk_scores (shipment_id, risk_level, overall_score, delay_probability, factors)
VALUES

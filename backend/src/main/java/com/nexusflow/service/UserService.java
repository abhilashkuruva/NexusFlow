...
public class UserService {
    ...
    public void createDefaultAdminIfNotExists() {
        ...
        boolean passwordMatches = admin.getPassword() != null
                && passwordEncoder.matches("admin123", admin.getPassword());

        admin.setEmail(adminEmail);
        admin.setPassword(passwordMatches ? admin.getPassword() : passwordEncoder.encode("admin123"));
        ...
        System.out.println("Login with: admin@nexusflow.com / admin123");
    }

    /**
     * Creates a demo user if they don't already exist.
     */
    public void createDemoUserIfNotExists(
